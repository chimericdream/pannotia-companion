...
public class WoolRecipes {
    public static final Pair<Identifier, JsonObject> BLACK_WOOL = new Pair<>(
        new Identifier("minecraft", "black_wool"),
        makeWoolRecipe("black")
    );
    public static final Pair<Identifier, JsonObject> BLUE_WOOL = new Pair<>(
        new Identifier("minecraft", "blue_wool"),
        makeWoolRecipe("blue")
    );
    public static final Pair<Identifier, JsonObject> BROWN_WOOL = new Pair<>(
        new Identifier("minecraft", "brown_wool"),
        makeWoolRecipe("brown")
    );
    public static final Pair<Identifier, JsonObject> CYAN_WOOL = new Pair<>(
        new Identifier("minecraft", "cyan_wool"),
        makeWoolRecipe("cyan")
    );
    public static final Pair<Identifier, JsonObject> GRAY_WOOL = new Pair<>(
        new Identifier("minecraft", "gray_wool"),
        makeWoolRecipe("gray")
    );
    public static final Pair<Identifier, JsonObject> GREEN_WOOL = new Pair<>(
        new Identifier("minecraft", "green_wool"),
        makeWoolRecipe("green")
    );
    public static final Pair<Identifier, JsonObject> LIGHT_BLUE_WOOL = new Pair<>(
        new Identifier("minecraft", "light_blue_wool"),
        makeWoolRecipe("light_blue")
    );
    public static final Pair<Identifier, JsonObject> LIGHT_GRAY_WOOL = new Pair<>(
        new Identifier("minecraft", "light_gray_wool"),
        makeWoolRecipe("light_gray")
    );
    public static final Pair<Identifier, JsonObject> LIME_WOOL = new Pair<>(
        new Identifier("minecraft", "lime_wool"),
        makeWoolRecipe("lime")
    );
    public static final Pair<Identifier, JsonObject> MAGENTA_WOOL = new Pair<>(
        new Identifier("minecraft", "magenta_wool"),
        makeWoolRecipe("magenta")
    );
    public static final Pair<Identifier, JsonObject> ORANGE_WOOL = new Pair<>(
        new Identifier("minecraft", "orange_wool"),
        makeWoolRecipe("orange")
    );
    public static final Pair<Identifier, JsonObject> PINK_WOOL = new Pair<>(
        new Identifier("minecraft", "pink_wool"),
        makeWoolRecipe("pink")
    );
    public static final Pair<Identifier, JsonObject> PURPLE_WOOL = new Pair<>(
        new Identifier("minecraft", "purple_wool"),
        makeWoolRecipe("purple")
    );
    public static final Pair<Identifier, JsonObject> RED_WOOL = new Pair<>(
        new Identifier("minecraft", "red_wool"),
        makeWoolRecipe("red")
    );
    public static final Pair<Identifier, JsonObject> WHITE_WOOL = new Pair<>(
        new Identifier("minecraft", "white_wool"),
        makeWoolRecipe("white")
    );
    public static final Pair<Identifier, JsonObject> YELLOW_WOOL = new Pair<>(
    ...
    public static final Pair<Identifier, JsonObject>[] WOOL_RECIPES = new Pair[]{
        BLACK_WOOL,
        BLUE_WOOL,
        BROWN_WOOL,
        CYAN_WOOL,
