...
public class TrapdoorsRecipes {
    public static final Pair<Identifier, JsonObject> ACACIA_TRAPDOOR = new Pair<>(
    ...
    public static final Pair<Identifier, JsonObject> BIRCH_TRAPDOOR = new Pair<>(
    ...
    public static final Pair<Identifier, JsonObject> CHERRY_TRAPDOOR = new Pair<>(
    ...
    public static final Pair<Identifier, JsonObject> CRIMSON_TRAPDOOR = new Pair<>(
    ...
    public static final Pair<Identifier, JsonObject> DARK_OAK_TRAPDOOR = new Pair<>(
    ...
    public static final Pair<Identifier, JsonObject> JUNGLE_TRAPDOOR = new Pair<>(
    ...
    public static final Pair<Identifier, JsonObject> MANGROVE_TRAPDOOR = new Pair<>(
    ...
    public static final Pair<Identifier, JsonObject> OAK_TRAPDOOR = new Pair<>(
    ...
    public static final Pair<Identifier, JsonObject> SPRUCE_TRAPDOOR = new Pair<>(
    ...
    public static final Pair<Identifier, JsonObject> WARPED_TRAPDOOR = new Pair<>(
    ...
    public static final Pair<Identifier, JsonObject>[] TRAPDOORS_RECIPES = new Pair[]{
        ACACIA_TRAPDOOR,
        BIRCH_TRAPDOOR,
        CHERRY_TRAPDOOR,
        CRIMSON_TRAPDOOR,
