...
public class PCRecipes {
    ...
    public static Pair<Identifier, JsonObject> ANDESITE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> BAMBOO_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> BIRCH_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> BLACKSTONE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> BRICK_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> CHERRY_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> COBBLED_DEEPSLATE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> COBBLESTONE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> CRIMSON_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> CUT_COPPER_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> DARK_OAK_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> DARK_PRISMARINE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> DEEPSLATE_BRICK_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> DEEPSLATE_TILE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> DIORITE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> END_STONE_BRICK_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> EXPOSED_CUT_COPPER_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> GRANITE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> JUNGLE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> MANGROVE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> MOSSY_COBBLESTONE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> MOSSY_STONE_BRICK_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> MUD_BRICK_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> NETHER_BRICK_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> OAK_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> OXIDIZED_CUT_COPPER_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> POLISHED_ANDESITE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> POLISHED_BLACKSTONE_BRICK_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> POLISHED_BLACKSTONE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> POLISHED_DEEPSLATE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> POLISHED_DIORITE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> POLISHED_GRANITE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> PRISMARINE_BRICK_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> PRISMARINE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> PURPUR_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> QUARTZ_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> RED_NETHER_BRICK_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> RED_SANDSTONE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> SANDSTONE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> SMOOTH_QUARTZ_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> SMOOTH_RED_SANDSTONE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> SMOOTH_SANDSTONE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> SPRUCE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> STONE_BRICK_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> STONE_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> WARPED_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> WAXED_CUT_COPPER_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> WAXED_EXPOSED_CUT_COPPER_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> WAXED_OXIDIZED_CUT_COPPER_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> WAXED_WEATHERED_CUT_COPPER_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject> WEATHERED_CUT_COPPER_STAIRS = new Pair<>(
    ...
    public static Pair<Identifier, JsonObject>[] ALL_RECIPES = new Pair[]{
        ACACIA_STAIRS,
        ANDESITE_STAIRS,
        BIRCH_STAIRS,
        BAMBOO_STAIRS,
